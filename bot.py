...
madlibs = [
    "[CALIFORNIA] is a [GREAT] [STATE]. You [WILL] have [LOTS] of fun there.",
    "I [LOVE] [CALIFORNIA]. I love my [STATE]. [EVERYONE] [SHOULD] come!",
    "You [SHOULD] move to [CALIFORNIA]! I [LOVE] it here. You [WILL] too! It is so [GREAT] here!",
    "I believe that [EVERYONE] [SHOULD] [TRY] this at least once. That's why [EVERYONE] [SHOULD] come to this [GREAT] [STATE]!",
    "Do [EVERYONE] [LOVE] [CALIFORNIA]? It is obvious that [EVERYONE] will not know this unless [TRY] the [STATE].",
    "Nowdays, [EVERYONE] from different [STATE] are all moving to the [GREAT] [CALIFORNIA]. You [SHOULD] do the same."
    ]

replacements = {
    'CALIFORNIA' : ['California', 'Minnesota', 'New York', 'Connecticut', 'Michigan'],
    'GREAT' : ['great', 'magnificent', 'fantastic', 'wonderful','amazing'],
    'STATE' : ['state', 'place', 'location', 'area','spot'],
    'WILL' : ['will', 'are able to', 'will able to','can', 'would'],
    'LOTS'  : ['lots', 'a whole lot', 'ridiculous amounts','plenty', 'a lot'],
    'LOVE' : ['love', 'adore', 'like','enjoy','appreciate'],
    'SHOULD' : ['should', 'must', 'need to','have to', 'shall'],
    'EVERYONE' : ['everyone', 'people', 'all students', 'people everywhere', 'you'],
    'TRY' : ['try', 'experience', 'seek','attempt','explore'],
    }
...
def generate_comment():
    ...
    For example, if we randomly seleected the madlib "I [LOVE] [PYTHON]",s
...
#submission_url = 'https://www.reddit.com/r/BotTownAlt/comments/r4fpgg/running_code/'
...
while True:
    ...
    for comment in all_comments:
        if str(comment.author) != 'professionalcs40bot':
    ...
    if has_not_commented:
        ...
        for comment in not_my_comments:
            if comment.author != 'professionalcs40bot':
                response = False
                for reply in comment.replies:
                    if str(reply.author) == 'professionalcs40bot':
                        response = True
    ...
    five_hottest_submission = []
    for submission in reddit.subreddit("BotTown2").hot(limit=5):
        five_hottest_submission.append(submission)
    newsubmission = random.choice(five_hottest_submission)
